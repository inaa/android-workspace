...
public class ArticlesAdapter extends BaseAdapter {
	...
	public ArticlesAdapter(Context context, List<ArticleDAO> list) {
	...
	public View getView(int index, View convertView, ViewGroup arg2) {
		ArticleDAO articlePreview = list.get(index);
		...
		if (null == convertView) {
			convertView = inflater.inflate(R.layout.article_preview_adapter,
					null);
