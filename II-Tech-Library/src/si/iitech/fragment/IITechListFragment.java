...
public abstract class IITechListFragment extends ListFragment {
	...
	protected void saveInSharedPreferences(String tag, String value) {
		...
		SharedPreferences sharedPreferences = parentActivity.getSharedPreferences(getApplicationName(), Context.MODE_PRIVATE);  
		SharedPreferences.Editor prefEditor = sharedPreferences.edit();  
		prefEditor.putString(tag, value);  
		prefEditor.commit();  
	}
	
	protected String retriveFromSharedPreferences(String tag, String defaultValue) {
		Activity parentActivity = getActivity();
		SharedPreferences sharedPreferences = parentActivity.getSharedPreferences(getApplicationName(), Context.MODE_PRIVATE);  
